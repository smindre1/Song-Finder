...
searchButton.addEventListener("click", function () {
  ...
  apiUrl = `https://cors-anywhere.herokuapp.com/https://api.musixmatch.com/ws/1.1/track.search?q_lyrics=${encodeURIComponent(
    lyricToSearch
  )}&f_track_release_group_first_release_date_min=${releaseDateMin}&apikey=${apiKey}`;
